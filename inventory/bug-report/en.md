...
layout: inventory
title: Bug Report
permalink: /inventory/bug-report/en/
lang: en
translations:
...
Please report any bugs you've found.
...
<form id="bug-form" style="max-width:600px;">
  ...
  <label style="display:block; margin-bottom:1rem;">
    Bug Title
    <input type="text" name="title" id="bug_title" required style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Summarize the bug in one line">
  </label>

  <label style="display:block; margin-bottom:1rem;">
    Steps to Reproduce
    <textarea name="steps" required rows="4" style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="1. Click ... button&#10;2. Enter ...&#10;3. Error occurs"></textarea>
  </label>
  ...
  <div class="muted" id="bug-email-hint" style="margin:.5rem 0 1rem; word-break: break-all;">Reporter: <span id="bug-email-value" style="display: inline-block; max-width: 100%;">Checking...</span></div>
...
(function(){
  var msg = {
    ...
    loginRequired: 'Login is required for bug reports.<br><br>Please login from the app first.<br><br><a href="/inventory/en/" class="btn">Home</a>',
    submitting: 'Submitting...',
    success: 'Thank you! Your bug report has been successfully submitted. (ID: ',
