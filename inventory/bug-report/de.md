...
layout: inventory
title: Fehlerbericht
permalink: /inventory/bug-report/de/
lang: de
translations:
...
Bitte melden Sie gefundene Fehler.
...
<form id="bug-form" style="max-width:600px;">
  ...
  <label style="display:block; margin-bottom:1rem;">
    Fehlertitel
    <input type="text" name="title" id="bug_title" required style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Fassen Sie den Fehler in einer Zeile zusammen">
  </label>

  <label style="display:block; margin-bottom:1rem;">
    Schritte zur Reproduktion
    <textarea name="steps" required rows="4" style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="1. ...Button klicken&#10;2. ...eingeben&#10;3. Fehler tritt auf"></textarea>
  </label>
  ...
  <div class="muted" id="bug-email-hint" style="margin:.5rem 0 1rem; word-break: break-all;">Melder: <span id="bug-email-value" style="display: inline-block; max-width: 100%;">Wird geprüft...</span></div>
...
(function(){
  var msg = {
    ...
    loginRequired: 'Für Fehlerberichte ist eine Anmeldung erforderlich.<br><br>Bitte melden Sie sich zuerst in der App an.<br><br><a href="/inventory/de/" class="btn">Startseite</a>',
    submitting: 'Wird gesendet...',
    success: 'Vielen Dank! Ihr Fehlerbericht wurde erfolgreich gesendet. (ID: ',
