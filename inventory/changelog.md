...
• 포켓: '파티션'이 '포켓'으로 변경, 자동 마이그레이션
• 새 UI: 확장형 프로필 헤더, 스피드 다이얼 FAB, 카테고리 필터 바
• 설정: 5개 접이식 그룹으로 재구성
• UI/UX: 상점 간소화, 뉴모픽 & 플랫 디자인, 우편함 바로가기, 홈 애니메이션
• 채팅: 1:1 동적 이름 표시, 그룹 참여자 수 표시
• 버그 수정: 알림창, 상점 헤더, 포켓 애니메이션
