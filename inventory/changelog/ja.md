...
#### パーティション管理の改善
新しいニューモーフィックデザインのパーティション名設定ダイアログとドラッグ並べ替え機能を追加しました。
- **ニューモーフィックダイアログ**: ダーク/ライトモード対応の美しい新デザイン
- **ドラッグ並べ替え**: ハンドルアイコンを長押ししてパーティションをドラッグして並べ替え
- **作成時に名前設定**: 新しいパーティション作成時にカスタム名を設定可能
...
- **パーティション間移動の利便性**: 多くのアイテムや複数のパーティションを素早く閲覧
