...
- **UI consistente**: Terminología unificada como 'Pocket' en toda la aplicación
- **Soporte multilingüe**: Traducido apropiadamente para cada idioma

#### Migración automática de datos
Los datos de 'Partition' existentes se convierten automáticamente a 'Pocket'.
- **Migración sin pérdida**: Sus particiones y artículos existentes se preservan exactamente
