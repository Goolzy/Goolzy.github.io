...
#### Adjuntos de chat renovados
El botón de adjuntos ahora es un panel flotante. Reúne fotos, vídeos, archivos y audio en un solo lugar, reordénalos arrastrando y envía varios tipos en un mismo mensaje.

#### Mensajes de voz
Graba hasta un minuto de audio en el chat y envíalo al instante. Disponible en móvil y escritorio.

#### Enviar dibujos a mano
Dibuja en un lienzo y envía tu boceto como imagen.

#### GIF animados
Busca GIF y envíalos directamente a la conversación.

#### Pegar desde el portapapeles
Pega imágenes, textos o enlaces copiados en el campo de escritura para adjuntarlos al instante.

#### Abrir enlaces en la app
Toca una tarjeta de enlace para abrirla en el navegador integrado. Si la app correspondiente está instalada, se abre directamente allí.

#### Visor multimedia unificado
Los visores de imagen, vídeo, audio, PDF y documentos ahora comparten una sola pantalla. Los documentos Markdown se muestran renderizados y el audio muestra su carátula y nombre de archivo.

#### Vuelve donde lo dejaste
Al regresar a una conversación, se abre justo donde estabas leyendo.

#### Notificaciones más fiables
Corregido que notificaciones de distintos chats o remitentes se sobrescribieran entre sí, y que no llegaran a algunos dispositivos.

#### Mejoras
- Las cuentas de correo ahora tienen un avatar generado automáticamente.
- El selector de galería ahora es propio y conserva los nombres de archivo originales.
- Corregida la redescarga del audio cada vez que se abría.
- Reducido el uso de red.
- Windows se recupera solo si la app no arranca.
- Pulidas traducciones faltantes y tipografía por idioma.
...
#### Modo horizontal en pantallas grandes
En pantallas grandes, ahora puedes ver la lista y los detalles lado a lado en modo horizontal. Tu posición se mantiene incluso al girar la pantalla.

#### Mejoras
Hemos reducido significativamente el tiempo de inicio de la aplicación y mejoramos la experiencia general del usuario en la entrada de chat, el diseño de la pantalla y los pagos en la tienda.

- Hemos mejorado significativamente la velocidad de inicio de la aplicación.
- La pantalla ahora se mueve suavemente junto con el teclado mientras escribes en el chat.
- Hemos mejorado la consistencia del diseño en toda la interfaz.
- Hemos aumentado la estabilidad de la tienda y los pagos.

#### Correcciones de errores
Mejoramos la estabilidad de la aplicación y corregimos problemas con los pagos, los efectos de sonido, el chat y el inicio de sesión.

- Hemos mejorado la estabilidad de la aplicación.
- Se ha corregido el problema de retrasos en la cancelación de pagos.
- Se ha corregido el problema de efectos de sonido reproduciéndose en modo silencioso.
- Se ha corregido el problema de que los mensajes anteriores y adjuntos desaparecían del chat.
- Se ha asegurado que la sesión se mantiene cuando reabre la aplicación.
...
#### Cambio de terminologia: Registro → Mensajes
La pestana 'Registro' ha sido renombrada a 'Mensajes'.
- Terminologia mas intuitiva aplicada en toda la interfaz

#### Conservacion de borradores de comentarios
Los comentarios que estas escribiendo se guardan automaticamente y se conservan incluso al salir de la pantalla.
- El texto de comentarios no enviados se restaura incluso despues de reiniciar la app
- Los elementos con borradores muestran un indicador '...' en la lista de mensajes

#### Memoria de posicion de desplazamiento
La pantalla de detalle del articulo recuerda tu ultima posicion de desplazamiento.
- Al reabrir la pantalla, comienza desde donde la dejaste

#### Mejora en notificaciones toast
Las notificaciones toast ahora se cierran secuencialmente en lugar de todas a la vez.
- Incluso cuando se acumulan multiples notificaciones, se cierran una por una para que no te pierdas ninguna
...
#### Reduccion de precios en la tienda
Se han reducido los precios predeterminados de los Sellos y las Insignias de Identificacion.
- **Sello**: $9.99 → $0.99
...
#### Mejoras en la Pantalla de Registro
Los iconos de insígnia de usuarios con insígnia se muestran correctamente en la pantalla de registro.
- **Visualización de icono de insígnia**: Las imágenes de insígnia se muestran en los comentarios de usuarios que portan insígnia
