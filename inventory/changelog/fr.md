...
#### Changement de terminologie : Journal → Messages
L'onglet « Journal » a ete renomme en « Messages ».
- Une terminologie plus intuitive appliquee dans toute l'interface

#### Conservation des brouillons de commentaires
Les commentaires en cours de redaction sont automatiquement sauvegardes et conserves meme lorsque vous quittez l'ecran.
- Le texte des commentaires non soumis est restaure meme apres le redemarrage de l'application
- Les elements avec des brouillons affichent un indicateur « ... » dans la liste des messages

#### Memorisation de la position de defilement
L'ecran de detail de l'article memorise votre derniere position de defilement.
- La reouverture de l'ecran reprend la ou vous vous etiez arrete

#### Amelioration des notifications toast
Les notifications toast sont desormais supprimees sequentiellement au lieu de toutes en meme temps.
- Meme lorsque plusieurs notifications s'accumulent, elles se ferment une par une pour ne rien manquer
...
#### Filtre de dossier de journal
Vous pouvez desormais filtrer les conversations par dossier dans l'ecran de journal.
- Utilisez le menu deroulant pour selectionner des dossiers specifiques et naviguer plus facilement dans les journaux

#### Refonte du tri des modeles partages
Les onglets de tri sur l'ecran des modeles partages ont ete repenses.
- Interface de tri intuitive pour trouver les modeles plus rapidement

#### Optimisation des notifications
Les notifications push inutiles ont ete nettoyees.
- Suppression des notifications inutiles liees aux mots-cles et aux flux d'actualites
- Amelioration de l'affichage du nom de l'expediteur pour les commentaires generes par le systeme

#### Corrections de bugs
- Correction d'un probleme ou les citations dans les reponses etaient cassees lorsque le commentaire original contenait des sauts de ligne
- Correction de l'affichage des documents pour qu'ils s'affichent toujours correctement dans la liste des journaux
...
#### Baisse des prix de la boutique
Les prix par defaut des Tampons et des Badges d'Identification ont ete reduits.
- **Tampon**: 9,99 $ → 0,99 $
...
#### Améliorations de l'Écran Journal
Les icônes de badge des utilisateurs portant un badge s'affichent désormais correctement dans l'écran Journal.
- **Affichage des icônes de badge** : L'image de badge s'affiche correctement dans les commentaires des utilisateurs qui portent un badge
...
#### Réponse rapide depuis les notifications push
Répondez directement depuis les notifications push sans ouvrir l'application.
- **Réponse en ligne** : Appuyez longuement sur une notification pour saisir un texte qui sera immédiatement publié comme commentaire sur l'article
- **Support hors ligne** : Les réponses sont automatiquement mises en file d'attente en cas de réseau instable et renvoyées au lancement de l'application
- **Support multilingue** : Les indications de saisie de réponse s'affichent selon les paramètres de langue de l'utilisateur
