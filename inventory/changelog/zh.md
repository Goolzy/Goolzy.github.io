...
#### 关键词同步增强
关键词的删除和更改会自动反映到印章、共享模板和复制物品中。

#### 网格视图改进
列数根据屏幕大小自动计算，物品文本始终显示。
...
- 修复了共享设置对话框标签颜色未跟随主题的问题
- 修复了Windows Store认证失败的问题
- 修复了抖动效果应用于所有物品而非仅完成文档的问题
