...
#### Shop Item Layout Improvement
Shop item layout has been improved for better visibility on mobile screens.
- **3-Row Structure**: Item information and price are separated, displaying without truncation even on narrow screens
- **Right-Aligned Price**: Price information is neatly placed on a separate row with right alignment
- **Sufficient Space for Discount Tags**: Item name and description are fully displayed even with discount badges
