...
layout: inventory
title: ご意見・ご要望
permalink: /inventory/suggest/ja/
lang: ja
translations:
...
<form id="suggest-form" style="max-width:600px;">
  ...
  <label style="display:block; margin-bottom:1rem;">
    タイトル
    <input type="text" name="title" id="suggest_title" required style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="提案を一行で要約してください">
  </label>

  <label style="display:block; margin-bottom:1rem;">
    内容
    <textarea name="content" required rows="6" style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="詳細を記入してください"></textarea>
  </label>
  <input type="hidden" name="email" id="suggest_email" value="">
  <input type="hidden" name="uid" id="suggest_uid" value="">
  <div class="muted" id="suggest-email-hint" style="margin:.5rem 0 1rem; word-break: break-all;">投稿者: <span id="suggest-email-value" style="display: inline-block; max-width: 100%;">確認中…</span></div>
...
(function(){
  var msg = {
    checking: 'ログイン状態を確認中…',
    loginRequired: 'ご意見・ご要望にはログインが必要です。<br><br>アプリからログインしてください。<br><br><a href="/inventory/ja/" class="btn">ホームへ</a>',
    submitting: '送信中…',
    success: 'ありがとうございます！ご提案が正常に送信されました。(ID: ',
    errorSubmit: '送信に失敗しました: ',
    errorFields: 'タイトルと内容の両方を入力してください。',
