...
layout: inventory
title: Sugerencias
permalink: /inventory/suggest/es/
lang: es
translations:
...
Por favor sugiere nuevas funciones o mejoras.
...
<form id="suggest-form" style="max-width:600px;">
  ...
  <label style="display:block; margin-bottom:1rem;">
    Título
    <input type="text" name="title" id="suggest_title" required style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Resume tu sugerencia en una línea">
  </label>

  <label style="display:block; margin-bottom:1rem;">
    Contenido
    <textarea name="content" required rows="6" style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Por favor escribe los detalles"></textarea>
  </label>
...
(function(){
  var msg = {
    ...
    loginRequired: 'Se requiere iniciar sesión para sugerencias.<br><br>Por favor inicia sesión primero desde la app.<br><br><a href="/inventory/es/" class="btn">Inicio</a>',
    submitting: 'Enviando...',
    success: '¡Gracias! Tu sugerencia se ha enviado correctamente. (ID: ',
    errorSubmit: 'Error al enviar: ',
    errorFields: 'Por favor ingresa el título y el contenido.',
