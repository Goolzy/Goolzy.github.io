...
layout: inventory
title: Vorschläge
permalink: /inventory/suggest/de/
lang: de
translations:
...
Bitte schlagen Sie neue Funktionen oder Verbesserungen vor.
...
<form id="suggest-form" style="max-width:600px;">
  ...
  <label style="display:block; margin-bottom:1rem;">
    Titel
    <input type="text" name="title" id="suggest_title" required style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Fassen Sie Ihren Vorschlag in einer Zeile zusammen">
  </label>

  <label style="display:block; margin-bottom:1rem;">
    Inhalt
    <textarea name="content" required rows="6" style="width:100%; padding:.5rem; margin-top:.25rem;" placeholder="Bitte schreiben Sie die Details"></textarea>
  </label>
  <input type="hidden" name="email" id="suggest_email" value="">
  <input type="hidden" name="uid" id="suggest_uid" value="">
  <div class="muted" id="suggest-email-hint" style="margin:.5rem 0 1rem; word-break: break-all;">Autor: <span id="suggest-email-value" style="display: inline-block; max-width: 100%;">Wird geprüft...</span></div>
...
(function(){
  var msg = {
    ...
    loginRequired: 'Für Vorschläge ist eine Anmeldung erforderlich.<br><br>Bitte melden Sie sich zuerst in der App an.<br><br><a href="/inventory/de/" class="btn">Startseite</a>',
    submitting: 'Wird gesendet...',
    success: 'Vielen Dank! Ihr Vorschlag wurde erfolgreich eingereicht. (ID: ',
    errorSubmit: 'Senden fehlgeschlagen: ',
    errorFields: 'Bitte geben Sie sowohl Titel als auch Inhalt ein.',
    errorUnknown: 'Ein unbekannter Fehler ist aufgetreten.',
    errorFirebase: 'Firebase ist nicht initialisiert. Bitte versuchen Sie es später erneut.'
  };
  ...
  form.addEventListener('submit', async function(e){
    ...
    try {
      ...
      console.error('[Suggest] Fehler:', err);
